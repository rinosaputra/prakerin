import {
    ...
    decimal,
    date,
    // pgUnique, # not used yet, but can be used for defining unique constraints
    index as pgIndex,
    uniqueIndex as pgUniqueIndex
} from 'drizzle-orm/pg-core';
// import { relations } from 'drizzle-orm'; # not used yet, but can be used for defining relations between tables
